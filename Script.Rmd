...
```{r sg v, fig.height = 2.5, fig.width = 2.5, fig.align = 'center', cache = TRUE}
...
```{r sg n, fig.height = 3, fig.width = 3, fig.align = 'center', cache = TRUE}
set.seed(125)
...
```{r sg i_p, fig.height = 2, fig.width = 4, fig.align = 'center', cache = TRUE}
set.seed(125)
generate_sg(v1 = runif(2), v2 = runif(2), v3 = runif(2),
            initial_point = c(3, 3),
...
```{r fractal k, fig.height = 2.5, fig.width = 2.5, fig.align = 'center', cache = TRUE}
ks    <- c(3  , 4   , 5  , 7   )
...
```{r bf proba I, fig.height = 2.5, fig.width = 3.85, fig.align = 'center', cache = TRUE}
...
```{r bf proba II, fig.height = 2.5, fig.width = 4.35, fig.align = 'center', cache = TRUE}
